...
class partner_ledger(report_sxw.rml_parse, common_report_header):

    def __init__(self, cr, uid, name, context=None):
        super(partner_ledger, self).__init__(cr, uid, name, context=context)
    ...
    def set_context(self, objects, data, ids, report_type=None):
        ...
        return super(partner_ledger, self).set_context(objects, data, ids, report_type)
    ...
    def process_moves(self, l, moves, prefix):
        ...
        for m in moves:
            ...
            date_changed = partner_changed or (not current_date) or current_date != date
...
report_sxw.report_sxw('report.partner_ledger_wizard', 'numa_ar_base.partner_ledger_wizard',
        'addons/numa_uniqs_base/report/partner_ledger.rml',parser=partner_ledger,
        header='internal')
